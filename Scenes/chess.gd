...
const PAWN_WHITE = preload("res://Assets/pawn_white.png")
const KNIGHT_WHITE = preload("res://Assets/knight_white.png")
const BISHOP_WHITE = preload("res://Assets/bishop_white.png")
const ROOK_WHITE = preload("res://Assets/rook_white.png")
const QUEEN_WHITE = preload("res://Assets/queen_white.png")
const KING_WHITE = preload("res://Assets/king_white.png")
const PAWN_BLACK = preload("res://Assets/pawn_black.png")
const KNIGHT_BLACK = preload("res://Assets/knight_black.png")
const BISHOP_BLACK = preload("res://Assets/bishop_black.png")
const ROOK_BLACK = preload("res://Assets/rook_black.png")
const QUEEN_BLACK = preload("res://Assets/queen_black.png")
const KING_BLACK = preload("res://Assets/king_black.png")
...
func display_board():
	...
	for i in BOARD_SIZE:
		for j in BOARD_SIZE:
			...
			match board[i][j]:
				-6: holder.texture = KING_BLACK
				-5: holder.texture = QUEEN_BLACK
				-4: holder.texture = ROOK_BLACK
				-3: holder.texture = BISHOP_BLACK
				-2: holder.texture = KNIGHT_BLACK
				-1: holder.texture = PAWN_BLACK
				0: holder.texture = null
				6: holder.texture = KING_WHITE
				5: holder.texture = QUEEN_WHITE
				4: holder.texture = ROOK_WHITE
